...
## Project Structure
    ...
    ├── mental_health_templ_38067  # Django project configurations
...
1. Clone this repo and `cd mental_health_templ_38067`
...
2. Clone this repo and `cd mental_health_templ_38067`
